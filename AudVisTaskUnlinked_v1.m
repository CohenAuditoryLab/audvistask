function [task, list] = AudVisTaskUnlinked_v1(dispInd)
...
readyprompt1.string = 'This task will consist of 1 block.';
...
function startTrial(list, block_rep, s)
    ...
    block.string = sprintf('Trial %d of %d', b, block_rep);
